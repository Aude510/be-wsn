...
class demonstration(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "demonstration")
        ...
        self.connect((self.fir_filter_xxx_0, 0), (self.digital_cma_equalizer_cc_0, 0))
        self.connect((self.fir_filter_xxx_0, 0), (self.qtgui_const_sink_x_0, 1))
        self.connect((self.fir_filter_xxx_0, 0), (self.qtgui_const_sink_x_2, 0))
...
def main(top_block_cls=demonstration, options=None):
